...
Namespace My.Resources
    ...
    '이 클래스는 StronglyTypedResourceBuilder
    '클래스에서 ResGen 또는 Visual Studio와 같은 도구를 통해 자동으로 생성되었습니다.
    '멤버를 추가하거나 제거하려면 .ResX 파일을 편집한 ResGen을
    '다음 /str 옵션을 사용하여 다시 실행하거나 VS 프로젝트를 다시 빌드하십시오.
    '<summary>
